...
class processingSetups:
      ...
      def useDefaultInfo(self):
            self.choosedHeaders=['individual-local-identifier','location-lat','location-long','height-above-ellipsoid','timestamp']
      ...
      def setBasicInfo(self,idHeaderName,latHeaderName,lngHeaderName,heightHeaderName,timestampHeaderName):
            self.choosedHeaders=[idHeaderName,latHeaderName,lngHeaderName,heightHeaderName,timestampHeaderName]
